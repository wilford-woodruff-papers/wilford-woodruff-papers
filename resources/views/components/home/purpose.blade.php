<div class="bg-white bg-center bg-no-repeat bg-opacity-25" style="background-image: url({{ asset('img/logo-opacity-25.png') }})">
    <div class="max-w-7xl mx-auto pt-8 md:pt-16 px-12 pb-4 xl:pt-8 md:px-36 md:pb-8">
        <div class="text-3xl md:text-4xl xl:text-3xl text-black pb-4 leanding-loose">
            <div class="grid grid-cols-3">
                <div class="font-extrabold">
                    <h2 class="uppercase pb-1 border-b-4 border-highlight">Purpose</h2>
                </div>
            </div>
            <p class="uppercase py-4 px-4 text-2xl text-center">
