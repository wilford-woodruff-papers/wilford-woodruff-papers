        ...
        <div>
            <div x-data="{
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 cursor-pointer hover:text-green-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div
                    ...
                    style="display: none;"
                    class="absolute right-0 bottom-10 z-10 mt-2 w-56 bg-white ring-1 ring-black ring-opacity-5 shadow-lg focus:outline-none"
                >
                    <div class="py-2 px-4">
                        Share
                    </div>

                    <div class="px-2 border-t border-gray-400">
                        <div class="flex gap-x-1 items-center px-6 hover:bg-gray-100">
                            ...
                            <a href="https://twitter.com/share?text={{ $media->title }}&url={{ route('landing-areas.ponder.press', ['press' =>$media->slug]) }}"
                               class="block py-2 px-4 w-full text-sm text-left"
                               target="_blank"
                            >
                                Twitter
                            </a>
            ...
            <div>
                @guest()
                    <button wire:click="login()">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 cursor-pointer hover:text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
