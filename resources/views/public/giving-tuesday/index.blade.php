...
{{--    <div class="bg-center bg-cover" style="background-image: url('{{ asset('img/giving-tuesday/background.jpg') }}');">--}}
{{--        <div class="py-24 mx-auto max-w-5xl">--}}
{{--            <h1 class="text-6xl font-black text-center text-white uppercase">--}}
{{--                Ways to Give--}}
{{--            </h1>--}}
{{--            <p class="mt-8 text-2xl font-semibold text-center text-white">--}}
{{--                Your generosity makes a difference.--}}
{{--            </p>--}}
{{--        </div>--}}
{{--    </div>--}}
    <div class="bg-center bg-cover" style="background-image: url('{{ asset('img/giving-tuesday/hero.png') }}');">
        <div class="pt-24 pb-12 mx-auto max-w-5xl">
            <h1 class="text-6xl font-black text-center text-white uppercase">
                Ways to Give
            </h1>
            <p class="mt-0 mb-12 text-2xl font-medium text-center text-white">
                Your generosity makes a difference.
            </p>
            <p class="text-center">
                <img src="{{ asset('img/giving-tuesday/GT_logo white.png') }}"
                     alt="Giving Tuesday"
                     class="mx-auto w-auto h-8"
                />
            </p>
            <p class="my-4 text-3xl text-center text-white">
                November 29, 2022
            </p>
            ...
            <div class="flex flex-col gap-y-2 mt-16">
                <p class="mx-auto max-w-6xl text-2xl font-semibold text-center text-white">
                    Each donation made today will be matched by a generous donor.
                </p>
                <p class="mx-auto max-w-2xl text-2xl text-center text-white">
    ...
    <div class="my-8 mx-auto max-w-xl text-center">
