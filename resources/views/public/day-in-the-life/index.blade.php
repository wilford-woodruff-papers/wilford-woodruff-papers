        ...
        <div class="">
            <div class="">
                <div class="flex flex-col gap-y-12">
                    ...
                    @include($sections['Documents']['view'], ['section' => $sections['Documents']])

                    @include($sections['People']['view'], ['section' => $sections['People']])

                    @include($sections['Places']['view'], ['section' => $sections['Places']])

                    @include($sections['Events']['view'], ['section' => $sections['Events']])

                    @include($sections['Quotes']['view'], ['section' => $sections['Quotes']])
