<div>
    <div class="property">
        <label for="event" class="block text-sm font-medium leading-6 text-gray-900"><h4>Events</h4></label>
        <div class="p-2 border-spacing-y-2">
            <div class="mb-4">
                <div id="eventAttachedToPhoto" class="hidden">
                    <div class="p-4 bg-green-50 rounded-md">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <div class="text-sm font-medium text-green-800">Event attached to photo</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="eventRemovedFromPhoto" class="hidden">
