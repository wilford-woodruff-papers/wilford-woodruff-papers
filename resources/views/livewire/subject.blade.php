                                    ...
                                    <div class="py-4">
                                        ...
                                        <div class="relative mt-1 rounded-md shadow-sm">
                                            <input wire:model.debounce="subject.name"
                                                   ...
                                                   name="name"
                                                   id="name"
                                                   class="block pl-4 w-full rounded-md border-gray-300 sm:text-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    ...
                                    <div class="py-4">
                                        ...
                                        <div class="relative mt-1 rounded-md shadow-sm">
                                            ...
                                            <input wire:model.debounce="query"
                                                   ...
                                                   name="query"
                                                   id="query"
                                                   class="block pl-10 w-full rounded-md border-gray-300 sm:text-sm focus:border-indigo-500 focus:ring-indigo-500"
