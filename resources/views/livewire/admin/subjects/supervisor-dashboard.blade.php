    ...
    <div class="mx-auto mt-4 max-w-7xl">
        <div class="py-4">
            ...
            <h1 class="mb-2 text-2xl font-semibold">
                Supervisor Dashboard: {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $dates['start'])->tz('America/Denver')->format('F Y') }} - {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $dates['end'])->tz('America/Denver')->format('F Y') }}
            </h1>
