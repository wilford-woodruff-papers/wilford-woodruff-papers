...
window.rangy = __webpack_require__(/*! ./rangy-core */ "./resources/js/rangy-core.js");
window.classapplier = __webpack_require__(/*! ./rangy-classapplier */ "./resources/js/rangy-classapplier.js");
window.highlighter = __webpack_require__(/*! ./rangy-highlighter */ "./resources/js/rangy-highlighter.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // A function is used for dragging and moving

function dragElement(element, direction) {
  var md; // remember mouse down info

  var first = document.getElementById("document-viewer");
  var second = document.getElementById("transcript");
...
/***/ "./resources/js/rangy-classapplier.js":
/*!********************************************!*\
  !*** ./resources/js/rangy-classapplier.js ***!
  \********************************************/
...
(function (factory, root) {
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./rangy-core */ "./resources/js/rangy-core.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  rangy.createModule("ClassApplier", ["WrappedSelection"], function (api, module) {
    ...
    function _hasClass(el, className) {
      if (_typeof(el.classList) == "object") {
    ...
    function hasAllClasses(el, className) {
      ...
      for (var i = 0, len = classes.length; i < len; ++i) {
        if (!_hasClass(el, trim(classes[i]))) {
          return false;
        }
      }
    ...
    function getEffectiveTextNodes(range) {
      var nodes = range.getNodes([3]); // Optimization as per issue 145
    ...
    function splitNodeAt(node, descendantNode, descendantOffset, positionsToPreserve) {
      ...
      if (isSplitPoint(descendantNode, descendantOffset)) {
        ...
        newNode = descendantNode.parentNode; // Work out a new split point in the parent node
    ...
    Merge.prototype = {
      doMerge: function doMerge(positionsToPreserve) {
    ...
    var optionProperties = ["elementTagName", "ignoreWhiteSpace", "applyToEditableOnly", "useExistingElements", "removeEmptyElements", "onElementCreate"]; // TODO: Populate this with every attribute name that corresponds to a property with a different name. Really??
    ...
    function ClassApplier(className, options, tagNames) {
      ...
      var elementPropertiesFromOptions = null,
          elementAttributes = {}; // Initialize from options object
      ...
      applier.normalize = typeof normalize == "undefined" ? true : normalize; // Initialize element properties and attribute exceptions

      applier.attrExceptions = [];
      var el = document.createElement(applier.elementTagName);
      applier.elementProperties = applier.copyPropertiesToElement(elementPropertiesFromOptions, el, true);
      each(elementAttributes, function (attrName, attrValue) {
        applier.attrExceptions.push(attrName); // Ensure each attribute value is a string

        elementAttributes[attrName] = "" + attrValue;
      });
      applier.elementAttributes = elementAttributes;
      applier.elementSortedClassName = applier.elementProperties.hasOwnProperty("className") ? sortClassName(applier.elementProperties.className + " " + className) : className; // Initialize tag names

      applier.applyToAnyTagName = false;

      var type = _typeof(tagNames);
    ...
    ClassApplier.prototype = {
      ...
      copyPropertiesToElement: function copyPropertiesToElement(props, el, createCopy) {
        var s,
            elStyle,
            elProps = {},
            elPropsStyle,
        ...
        for (var p in props) {
          if (props.hasOwnProperty(p)) {
            propValue = props[p];
            elPropValue = el[p]; // Special case for class. The copied properties object has the applier's class as well as its own
            ...
            if (p == "className") {
              ...
              el[p] = propValue; // Copy the property back from the dummy element so that later comparisons to check whether
              // elements may be removed are checking against the right value. For example, the href property
              // of an element returns a fully qualified URL even if it was previously assigned a relative
              // URL.

              if (createCopy) {
                elProps[p] = el[p]; // Not all properties map to identically-named attributes
      ...
      copyAttributesToElement: function copyAttributesToElement(attrs, el) {
      ...
      appliesToElement: function appliesToElement(el) {
        return contains(this.tagNames, el.tagName.toLowerCase());
      },
      getEmptyElements: function getEmptyElements(range) {
        var applier = this;
      ...
      hasClass: function hasClass(node) {
        return node.nodeType == 1 && (this.applyToAnyTagName || this.appliesToElement(node)) && _hasClass(node, this.className);
      },
      getSelfOrAncestorWithClass: function getSelfOrAncestorWithClass(node) {
        while (node) {
      ...
      isModifiable: function isModifiable(node) {
        return !this.applyToEditableOnly || isEditable(node);
      },
      // White space adjacent to an unwrappable node can be ignored for wrapping
      isIgnorableWhiteSpaceNode: function isIgnorableWhiteSpaceNode(node) {
        return this.ignoreWhiteSpace && node && node.nodeType == 3 && isUnrenderedWhiteSpaceNode(node);
      },
      // Normalizes nodes after applying a class to a Range.
      postApply: function postApply(textNodes, range, positionsToPreserve, isUndo) {
        ...
        var textNode, precedingTextNode; // Check for every required merge and create a Merge object for each
      ...
      createContainer: function createContainer(parentNode) {
      ...
      elementHasProperties: function elementHasProperties(el, props) {
        var applier = this;
      ...
      elementHasAttributes: function elementHasAttributes(el, attrs) {
      ...
      applyToTextNode: function applyToTextNode(textNode, positionsToPreserve) {
      ...
      undoToTextNode: function undoToTextNode(textNode, range, ancestorWithClass, positionsToPreserve) {
      ...
      splitAncestorWithClass: function splitAncestorWithClass(container, offset, positionsToPreserve) {
      ...
      undoToAncestor: function undoToAncestor(ancestorWithClass, positionsToPreserve) {
        if (this.isRemovable(ancestorWithClass)) {
          replaceWithOwnChildrenPreservingPositions(ancestorWithClass, positionsToPreserve);
        } else {
          removeClass(ancestorWithClass, this.className);
      ...
      applyToRange: function applyToRange(range, rangesToPreserve) {
        var applier = this;
        rangesToPreserve = rangesToPreserve || []; // Create an array of range boundaries to preserve

        var positionsToPreserve = getRangeBoundaries(rangesToPreserve || []);
        range.splitBoundariesPreservingPositions(positionsToPreserve); // Tidy up the DOM by removing empty containers
      ...
      applyToRanges: function applyToRanges(ranges) {
        var i = ranges.length;
      ...
      applyToSelection: function applyToSelection(win) {
        var sel = api.getSelection(win);
        sel.setRanges(this.applyToRanges(sel.getAllRanges()));
      },
      undoToRange: function undoToRange(range, rangesToPreserve) {
        var applier = this; // Create an array of range boundaries to preserve
      ...
      undoToRanges: function undoToRanges(ranges) {
      ...
      undoToSelection: function undoToSelection(win) {
        var sel = api.getSelection(win);
      ...
      isAppliedToRanges: function isAppliedToRanges(ranges) {
        var i = ranges.length;
      ...
      isAppliedToSelection: function isAppliedToSelection(win) {
        var sel = api.getSelection(win);
      ...
      toggleSelection: function toggleSelection(win) {
      ...
      getElementsWithClassIntersectingRange: function getElementsWithClassIntersectingRange(range) {
        var elements = [];
        var applier = this;
...
(function (factory, root) {
  ...
  var modules = {};
  var isBrowser = (typeof window === "undefined" ? "undefined" : _typeof(window)) != UNDEFINED && (typeof document === "undefined" ? "undefined" : _typeof(document)) != UNDEFINED;
  var util = {
  ...
  var api = {
    ...
    config: {
      ...
      autoInitialize: (typeof rangyAutoInitialize === "undefined" ? "undefined" : _typeof(rangyAutoInitialize)) == UNDEFINED ? true : rangyAutoInitialize
    }
  };

  function consoleLog(msg) {
    if ((typeof console === "undefined" ? "undefined" : _typeof(console)) != UNDEFINED && isHostMethod(console, "log")) {
      console.log(msg);
    }
  }
  ...
  if ({}.hasOwnProperty) {
    util.extend = _extend = function extend(obj, props, deep) {
      var o, p;
      ...
      for (var i in props) {
        if (props.hasOwnProperty(i)) {
          ...
          if (deep && o !== null && _typeof(o) == "object" && p !== null && _typeof(p) == "object") {
            _extend(o, p, true);
          }
    ...
    util.createOptions = function (optionsParam, defaults) {
      ...
      _extend(options, defaults);

      if (optionsParam) {
        _extend(options, optionsParam);
      }
  ...
  if (isBrowser) {
    if (isHostMethod(document, "addEventListener")) {
      addListener = function addListener(obj, eventType, listener) {
  ...
  api.createCoreModule("DomUtil", [], function (api, module) {
    ...
    if (!util.areHostMethods(el, ["insertBefore", "appendChild", "cloneNode"] || 0)) {
    ...
    if (!util.areHostMethods(textNode, ["splitText", "deleteData", "insertData", "appendData", "cloneNode"] || 0 || 0)) {
    ...
    if (_typeof(window.getComputedStyle) != UNDEF) {
      getComputedStyleProperty = function getComputedStyleProperty(el, propName) {
        return getWindow(el).getComputedStyle(el, null)[propName];
      };
    } else if (_typeof(document.documentElement.currentStyle) != UNDEF) {
      getComputedStyleProperty = function getComputedStyleProperty(el, propName) {
  ...
  api.createCoreModule("DomRange", ["DomUtil"], function (api, module) {
    ...
    util.extend(api.rangePrototype, {
      ...
      detach: function detach() {// In DOM4, detach() is now a no-op.
      }
    });
  ...
  api.createCoreModule("WrappedRange", ["DomRange"], function (api, module) {
    ...
    if (api.features.implementsTextRange) {
      ...
      */
      ...
      WrappedTextRange = function WrappedTextRange(textRange) {
  ...
  api.createCoreModule("WrappedSelection", ["DomRange", "WrappedRange"], function (api, module) {
    ...
    var selectionHasRangeCount = _typeof(testSelection.rangeCount) == NUMBER;
    ...
    if (util.areHostMethods(testSelection, ["addRange", "getRangeAt", "removeAllRanges"]) && _typeof(testSelection.rangeCount) == NUMBER && features.implementsDomRange) {
      (function () {
        ...
        if (sel) {
          ...
          var textNode = testEl.appendChild(document.createTextNode("\xA0\xA0\xA0")); // Test whether the native selection will allow a collapsed selection within a non-editable element
    ...
    } else if (isHostMethod(testSelection, "getRangeAt") && _typeof(testSelection.rangeCount) == NUMBER) {
      refreshSelection = function refreshSelection(sel) {
    ...
    } else if (selectionHasAnchorAndFocus && _typeof(testSelection.isCollapsed) == BOOLEAN && _typeof(testRange.collapsed) == BOOLEAN && features.implementsDomRange) {
      refreshSelection = function refreshSelection(sel) {
        var range,
...
/***/ "./resources/js/rangy-highlighter.js":
/*!*******************************************!*\
  !*** ./resources/js/rangy-highlighter.js ***!
  \*******************************************/
/***/ (function(module, exports, __webpack_require__) {
...
(function (factory, root) {
  ...
  rangy.createModule("Highlighter", ["ClassApplier"], function (api, module) {
    ...
    var nextHighlightId = 1; // Puts highlights in order, last in document first.

    function compareHighlights(h1, h2) {
      return h1.characterRange.start - h2.characterRange.start;
    }

    function _getContainerElement(doc, id) {
    ...
    CharacterRange.prototype = {
      intersects: function intersects(charRange) {
        return this.start < charRange.end && this.end > charRange.start;
      },
      isContiguousWith: function isContiguousWith(charRange) {
        return this.start == charRange.end || this.end == charRange.start;
      },
      union: function union(charRange) {
        return new CharacterRange(Math.min(this.start, charRange.start), Math.max(this.end, charRange.end));
      },
      intersection: function intersection(charRange) {
        return new CharacterRange(Math.max(this.start, charRange.start), Math.min(this.end, charRange.end));
      },
      getComplements: function getComplements(charRange) {
        var ranges = [];
    ...
    var textContentConverter = {
      rangeToCharacterRange: function rangeToCharacterRange(range, containerNode) {
        var bookmark = range.getBookmark(containerNode);
        return new CharacterRange(bookmark.start, bookmark.end);
      },
      characterRangeToRange: function characterRangeToRange(doc, characterRange, containerNode) {
        var range = api.createRange(doc);
      ...
      serializeSelection: function serializeSelection(selection, containerNode) {
      ...
      restoreSelection: function restoreSelection(selection, savedSelection, containerNode) {
    ...
    Highlight.prototype = {
      getContainerElement: function getContainerElement() {
        return _getContainerElement(this.doc, this.containerElementId);
      },
      getRange: function getRange() {
        return this.converter.characterRangeToRange(this.doc, this.characterRange, this.getContainerElement());
      },
      fromRange: function fromRange(range) {
        this.characterRange = this.converter.rangeToCharacterRange(range, this.getContainerElement());
      },
      getText: function getText() {
        return this.getRange().toString();
      },
      containsElement: function containsElement(el) {
      ...
      getHighlightElements: function getHighlightElements() {
    ...
    Highlighter.prototype = {
      addClassApplier: function addClassApplier(classApplier) {
        this.classAppliers[classApplier.className] = classApplier;
      },
      getHighlightForElement: function getHighlightForElement(el) {
      ...
      removeHighlights: function removeHighlights(highlights) {
      ...
      getIntersectingHighlights: function getIntersectingHighlights(ranges) {
      ...
      highlightCharacterRanges: function highlightCharacterRanges(className, charRanges, options) {
        var i, len, j;
        var highlights = this.highlights;
        ...
        for (i = 0, len = charRanges.length; i < len; ++i) {
          ...
          highlightsToKeep = []; // Restrict character range to container element, if it exists
          ...
          for (j = 0; j < highlights.length; ++j) {
            ...
            if (containerElementId == highlights[j].containerElementId) {
              ...
              splitHighlight = !isSameClassApplier && exclusive; // Replace the existing highlight if it needs to be:
      ...
      highlightRanges: function highlightRanges(className, ranges, options) {
        var selCharRanges = [];
        var converter = this.converter;
        options = createOptions(options, {
      ...
      highlightSelection: function highlightSelection(className, options) {
        var converter = this.converter;
        ...
        var containerElement = _getContainerElement(doc, containerElementId);
        ...
        var serializedSelection = converter.serializeSelection(selection, containerElement); // Create an array of selected character ranges
      ...
      unhighlightSelection: function unhighlightSelection(selection) {
      ...
      getHighlightsInSelection: function getHighlightsInSelection(selection) {
        selection = selection || api.getSelection(this.doc);
        return this.getIntersectingHighlights(selection.getAllRanges());
      },
      selectionOverlapsHighlight: function selectionOverlapsHighlight(selection) {
      ...
      serialize: function serialize(options) {
        ...
        forEach(highlights, function (highlight) {
          ...
          var containerElement; // Convert to the current Highlighter's type, if different from the serialization type

          if (convertType) {
            containerElement = highlight.getContainerElement();
            characterRange = serializationConverter.rangeToCharacterRange(highlighter.converter.characterRangeToRange(highlighter.doc, characterRange, containerElement), containerElement);
          }
      ...
      deserialize: function deserialize(serialized) {
        ...
        for (var i = serializedHighlights.length, parts; i-- > 0;) {
          ...
          containerElementId = parts[4] || null; // Convert to the current Highlighter's type, if different from the serialization type

          if (convertType) {
            containerElement = _getContainerElement(this.doc, containerElementId);
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/postcss-loader/dist/cjs.js):\nError: ENOENT: no such file or directory, stat './storage/framework/views/8a23e47c9a7a838cd49171fa9827b782b1d25bce.php'\n    at Object.statSync (node:fs:1551:3)\n    at resolveChangedFiles (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:161:36)\n    at resolvedChangedContent (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:145:29)\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:56:44\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/processTailwindFeatures.js:38:11\n    at plugins (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/index.js:30:63)\n    at LazyResult.runOnRoot (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:339:16)\n    at LazyResult.runAsync (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:393:26)\n    at LazyResult.async (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:221:30)\n    at LazyResult.then (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:206:17)\n    at processResult (/Users/jon/code/wilford-woodruff-papers/node_modules/webpack/lib/NormalModule.js:758:19)\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/webpack/lib/NormalModule.js:860:5\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:400:11\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:252:18\n    at context.callback (/Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:124:13)\n    at Object.loader (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss-loader/dist/index.js:142:7)");
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/postcss-loader/dist/cjs.js):\nError: ENOENT: no such file or directory, stat './storage/framework/views/8d2973deafbb66a0c9f857eff4f2635cde0d02f0.php'\n    at Object.statSync (node:fs:1551:3)\n    at resolveChangedFiles (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:161:36)\n    at resolvedChangedContent (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:145:29)\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/lib/setupTrackingContext.js:56:44\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/processTailwindFeatures.js:38:11\n    at plugins (/Users/jon/code/wilford-woodruff-papers/node_modules/tailwindcss/lib/index.js:30:63)\n    at LazyResult.runOnRoot (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:339:16)\n    at LazyResult.runAsync (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:393:26)\n    at LazyResult.async (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:221:30)\n    at LazyResult.then (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss/lib/lazy-result.js:206:17)\n    at processResult (/Users/jon/code/wilford-woodruff-papers/node_modules/webpack/lib/NormalModule.js:758:19)\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/webpack/lib/NormalModule.js:860:5\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:400:11\n    at /Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:252:18\n    at context.callback (/Users/jon/code/wilford-woodruff-papers/node_modules/loader-runner/lib/LoaderRunner.js:124:13)\n    at Object.loader (/Users/jon/code/wilford-woodruff-papers/node_modules/postcss-loader/dist/index.js:142:7)");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/css/transcript.css");
/******/ 	
/******/ })()
;