    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->markdown('mail.export.uncategorized-subjects', [
                'link' => url('/nova/resources/subjects?subjects_page=1&subjects_per_page=100&subjects_filter=').base64_encode(json_encode([['Rpj\\Daterangepicker\\Daterangepicker' => "'.$start.' to '.$end.'"], ['App\\Nova\\Filters\\SubjectType' => '-1']])),
