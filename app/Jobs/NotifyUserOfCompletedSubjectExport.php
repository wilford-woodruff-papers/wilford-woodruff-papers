...
use App\Models\User;
use App\Notifications\ExportUncategorizedSubjects;
...
class NotifyUserOfCompletedSubjectExport implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($this->users as $user) {
            ...
            $user->notify(new ExportUncategorizedSubjects($this->filename, $this->subject));
        }
    }
}
