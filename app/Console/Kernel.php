...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule
            ->command('stats:published-site-documents')
            ->monthlyOn(1, '2:00 AM')
            ->timezone('America/Denver')
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org')
        ...
        $schedule
            ->command('stats:published-site-pages')
            ->monthlyOn(1, '2:05 AM')
            ->timezone('America/Denver')
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org')
        ...
        $schedule
            ->command('stats:published-site-subjects')
            ->monthlyOn(1, '2:10 AM')
            ->timezone('America/Denver')
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org')
        ...
        $schedule
            ->command('stats:uploaded-ftp-documents')
            ->monthlyOn(1, '2:20 AM')
            ->timezone('America/Denver')
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org')
        ...
        $schedule
            ->command('instagram-feed:refresh-tokens')
            ->lastDayOfMonth()
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org');

        $schedule
            ->command('newsletters:import')
            ->dailyAt('4:10 AM')
            ->timezone('America/Denver')
            ->emailOutputTo('jon.fackrell@wilfordwoodruffpapers.org');
